...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────┐
│                                PATRON VISITEUR - STRUCTURE                                  │
├─────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                             │
│  HIÉRARCHIE 1: ÉLÉMENTS          │          HIÉRARCHIE 2: VISITEURS                         │
│  (ce qu'on visite)               │          (comment on le traite)                          │
│                                  │                                                          │
│     ┌──────────────────────┐     │     ┌──────────────────────┐                             │
│     │   «interface»        │     │     │   «interface»        │                             │
│     │      IElement        │     │     │     IVisiteur        │                             │
...
│                                  │                                                          │
│  - Indépendantes                 │                                                          │
│  - Pas de création ensemble      │  - Pas d'import/modification d'éléments                  │
│  - Une seule responsabilité      │  - Nouvelles opérations = nouveaux visiteurs             │
│                                  │                                                          │
└─────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌────────────────────────────────────────────────────────────────────────────────────┐
│                         FLUX D'EXÉCUTION - DOUBLE DISPATCH                         │
├────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                    │
│  Client                                                                            │
│    │                                                                               │
│    │  element.accepter(visiteur)    ◄─── 1ER DISPATCH                              │
│    │─────────────────────────────►  (type réel de element = Cercle)                │
│    │                                                                               │
│    │                             Cercle::accepter()                                │
│    │                             {                                                 │
...
│    │                                       │                                       │
│    │                                       │  2E DISPATCH                          │
│    │                                       │  (type réel de visiteur = CalcAire)   │
│    │                                       ▼                                       │
│    │                             CalcAire::visiterCercle()                         │
│    │                             {                                                 │
│    │                               totalAire += PI * r * r                         │
│    │                             }                                                 │
│    │◄──────────────────────────────────                                            │
│    │                                                                               │
│                                                                                    │
│  RÉSULTAT: Deux niveaux de polymorphisme!                                          │
│  • 1er: Quel type d'élément?   → appelle accepter()                                │
│  • 2e: Quel type de visiteur?   → appelle visiterX()                               │
│                                                                                    │
└────────────────────────────────────────────────────────────────────────────────────┘
```
