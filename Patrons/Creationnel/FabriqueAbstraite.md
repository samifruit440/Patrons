...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    PATRON FABRIQUE ABSTRAITE - STRUCTURE                    │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│                                     ┌─────────────┐                         │
│                                     │   Client    │                         │
...
│          │FabriqueAbs  │              │ ProduitA    │   │ ProduitB   │      │
│          ├─────────────┤              ├─────────────┤   ├────────────┤      │
│          │+creerA()    │              │+operationA()│   │+operationB │      │
│          │+creerB()    │              └──────△─────┘   └──────△────┘      │
│          └──────△─────┘                      │                 │           │     
│                 │                             │                 │           │
│   ┌─────────────┴─────────────┐               │                 │           │     
...
│                                                                             │                 
│                                                                             │         
│  Les produits d'une même fabrique sont conçus pour fonctionner ensemble     │                 
│  • Fabrique1 crée: ProduitA1 + ProduitB1 (Famille 1)                        │             
│  • Fabrique2 crée: ProduitA2 + ProduitB2 (Famille 2)                        │             
│  • Client ne dépend que des interfaces, pas des implémentations             │         
│                                                                             │     
└─────────────────────────────────────────────────────────────────────────────┘
```
