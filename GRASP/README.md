...
// ✅ BON: Chaque classe calcule ce qu'elle connaît, on utilise les attributs 
// privé directement !
class LigneCommande {
private:
    Produit* produit;
...
### ❌ Inconvénients
- Création complexe → utiliser une [Fabrique](../Patrons/Creationnel/Fabrique.md) !
